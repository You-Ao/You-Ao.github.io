...
!!! details 图片的频率
    ...
    ![](./pic/Lecture_3/vcb_spatial.png){ height="250"}
...
!!! details 可能造成的情况
    ...
    ![=x250](./pic/Lecture_3/aliasing_example.png){ width="400"}

    - 车轮错觉 (wagon wheel illusion)
  
    对于不同频率的信号使用相同采样率的结果：

    ![=x250](./pic/Lecture_3/sample_time.png){ width="400"}
...
!!! details 示例
    ...
    ![=x150](./pic/Lecture_3/anti_aliasing1.png){width="80%"}

    ![=x150](./pic/Lecture_3/anti_aliasing2.png){width="80%"}
